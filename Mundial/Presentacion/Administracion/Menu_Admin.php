    ...
    <ul class="nav">
                                        ...
                                        <li><a href="#">Partidos</a>
                                            <ul>
                                                ...
                                                <li><a href="A_Alineacion_Admin.php">Asignar Alineaciones al Partido</a></li>
                                                <li><a href="A_Alineacion_O_Admin.php">Asignar Observaciones al Partido</a></li>
                                            </ul>
                                        </li>
