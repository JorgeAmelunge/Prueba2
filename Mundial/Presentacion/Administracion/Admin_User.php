...
$(document).ready(function() {
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav pull-right">
             ...
             <li><a href="../Principales/Partidos.php">Partidos</a></li>
             <li><a href="../Principales/Posiciones.php">Posiciones</a>
  ...
  <hr>
        ...
        <a name="lfpb"> <div class="content_adm" align="center"></a>
            <h2 class="page-heading"><span>Inicio de Sesión</span></h2>
                <div style="text-align: center">
                    <form action="../autentificacion/login.php" method="post" id="form">
                    ...
                    <form action="../Administracion/Registro_User.php" method="post" id="form2">
                        <div id="login-box-name" style="margin-top:20px;color: gray">¿Aún no estás Registrado?</div>
                        <input name="Registro" type="submit" class="boton" id="enviar" value="Regístrate" /> 
                    </form>
