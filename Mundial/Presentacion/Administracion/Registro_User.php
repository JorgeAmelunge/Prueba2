...
$(document).ready(function() {
  ...
  <hr>
        ...
        <a name="lfpb"> <div class="content_adm" align="center"></a>
                                        <h2 class="page-heading"><span>Regístrate</span></h2>
                                        <div style="text-align: center">
                                        <form action="../autentificacion/registro.php" method="post" id="form">
                                        ...
                                        <div id="login-box-name">Confirme su Password:</div><div id="login-box-field">
                                        <input name="clave2" type="password" id="clave2" class="form-login" title="Password" value="" size="30" maxlength="2048" /></div>
                                        <br />
                                        <input name="Cancelar" type="submit" class="boton" id="enviar" value="Guardar" />
                                        </form>
                                        </div>
